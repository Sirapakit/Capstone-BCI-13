...
# del main_array_channel_23, main_array_channel_24, main_array_channel_25, main_array_channel_26, main_array_channel_27, main_array_channel_28
print('--------Stop--------')
...
# Save file take some times
print('-------May take long time to save, be patient---------')
filename = "./8bands-nonorm/8bands-chb01-nonorm.npy"
