...
# chb10 in oversampling (1, 13, 17, 19)
...
patient_chb = "chb10"
data_channel_1 = np.load('../convert-all-channel-edf/edf-concat/chb10/chn1-chb10.npy')
data_channel_2 = np.load('../convert-all-channel-edf/edf-concat/chb10/chn13-chb10.npy')
data_channel_3 = np.load('../convert-all-channel-edf/edf-concat/chb10/chn17-chb10.npy')
data_channel_4 = np.load('../convert-all-channel-edf/edf-concat/chb10/chn19-chb10.npy')
