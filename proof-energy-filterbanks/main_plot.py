...
path = r'/Users/sirap/Documents/Capstone-BCI-13/create_new_filterbank/new_energy_bands/chb01/data_chb01_14_energy_v2.npy'
data = np.load(path)
...
seizure_info = {'start': 1732, 'stop': 1777}
# Green = Onset start
# Red = Seizure period

# dash_line = { 'first': 665, 'second': 1001, 'third': 1007}

xlim = {'start': 1732 -200, 'stop': 1777+ 100}
